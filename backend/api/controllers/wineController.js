  ...
  try {
    const wine = await prisma.wine.create({
      data: {
        ...
        preco: price,
        imagem, // Armazena diretamente o nome ou caminho do arquivo
...
const updateWine = async (req, res) => {
  ...
  try {
    ...
    if (imagem) updateData.imagem = imagem; // Apenas o nome ou caminho do arquivo
...
const deleteWine = async (req, res) => {
  ...
  try {
    ...
    // Remova os relacionamentos e o vinho
